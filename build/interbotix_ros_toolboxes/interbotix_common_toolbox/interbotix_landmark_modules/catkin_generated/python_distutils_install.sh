...
echo_and_run cd "/home/fac/interbotix_ws/src/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_landmark_modules"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/fac/interbotix_ws/src/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_landmark_modules/setup.py" \
     \
    build --build-base "/home/fac/interbotix_ws/build/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_landmark_modules" \
    install \
    --root="${DESTDIR-/}" \
