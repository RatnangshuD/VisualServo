...
echo_and_run cd "/home/fac/interbotix_ws/src/interbotix_ros_toolboxes/interbotix_rpi_toolbox/interbotix_rpi_modules"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/fac/interbotix_ws/src/interbotix_ros_toolboxes/interbotix_rpi_toolbox/interbotix_rpi_modules/setup.py" \
     \
    build --build-base "/home/fac/interbotix_ws/build/interbotix_ros_toolboxes/interbotix_rpi_toolbox/interbotix_rpi_modules" \
    install \
    --root="${DESTDIR-/}" \
